...
const featureCards = [
  ...
  },
  {
    ...
    description: "Dashboard charts showing spending patterns and trends",
    gradient: "from-green-500/20 to-teal-500/20"
  },
  {
    icon: Bell,
    title: "Budget Alerts",
    description: "Get notified when you approach category spending limits",
    gradient: "from-orange-500/20 to-red-500/20"
  },
  {
    icon: FileText,
    title: "PDF Exports",
    description: "Clean statements you can share for records or reimbursement",
    gradient: "from-indigo-500/20 to-blue-500/20"
  },
  {
    icon: Repeat,
    title: "Recurring Reminders",
    description: "Never miss a payment with automated transaction reminders",
    gradient: "from-pink-500/20 to-rose-500/20"
  },
  {
    icon: BarChart3,
    title: "Loan Management",
    description: "Track lend/borrow with partial repayments and due dates",
...
export default function Mission() {
  ...
  return (
    <section id="features" ref={ref} className="px-6  md:px-12 pt-10 pb-32 md:pb-20">
      <div className="max-w-6xl mx-auto mb-20">
        <p className="text-2xl md:text-4xl lg:text-5xl  font-medium tracking-[-4px] leading-[1.2]">
          {p1.map((w, i) => {
            const start = i / total;
            const end = (i + 4) / total;
