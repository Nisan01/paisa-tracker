...
export function RevenueChart() {
  return (
    <div className="bg-card border border-border rounded-xl p-5 h-[380px] min-w-0 overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          >
            ...
            <Tooltip
              contentStyle={{
                ...
                border:
                  "1px solid oklch(0.18 0.002 260)",
                borderRadius: "8px",
                fontSize: "12px",
              }}
              labelStyle={{
