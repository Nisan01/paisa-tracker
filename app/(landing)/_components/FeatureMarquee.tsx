...
const features = [
  ...
  },
  {
    ...
    num: "03",
    title: "Loan tracking",
    desc: "Track lent, borrowed money with partial repayments.",
    tag: "loans",
  },
  {
    icon: BiBell,
  ...
  },
  {
    ...
    num: "06",
    title: "Trips and reminders",
    desc: "Track trip budgets and set reminders so you never miss payments.",
    tag: "trips",
  },
];
...
function FeatureCard({ f }: { f: (typeof features)[0] }) {
  ...
  return (
    <div className="w-[260px] sm:w-[300px] md:w-[340px] shrink-0 flex flex-col gap-1.8 rounded-2xl border border-gray-400/20 border-border/30 hover:border-border/60 transition-all bg-black backdrop-blur-xl p-5 md:p-6 mx-2.5">
