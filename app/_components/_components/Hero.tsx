...
export default function Hero() {
  return (
    <section id="home" className="relative min-h-screen mb-20 flex flex-col items-center w-full overflow-hidden">
      <video
        autoPlay
        muted
        loop
        playsInline
        className="absolute top-40 max-w-5xl h-full object-contain"
        src="./hero-bg2.mp4"
      />
...
>                 <p>
        ...
        <motion.h1
          {...fadeUp(0.1)}
          className="text-5xl md:text-7xl lg:text-8xl font-medium tracking-[-2px] max-w-5xl text-foreground"
        >
